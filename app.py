...
app.config["MAIL_USERNAME"] = "arinzemaxwell22@gmail.com"
app.config["MAIL_PASSWORD"] = "ygfpemxhcbuhldjp"
...
def index():
    if request.method == "POST":
        ...
        message = Message(subject="New form", sender=app.config["MAIL_USERNAME"],
